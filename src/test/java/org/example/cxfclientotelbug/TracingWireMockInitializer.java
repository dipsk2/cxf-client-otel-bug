...
public class TracingWireMockInitializer implements ApplicationContextInitializer<ConfigurableApplicationContext> {
    ...
    public void initialize(ConfigurableApplicationContext context) {
        ...
        TestPropertyValues.of(Map.of(zipkinEndpointProperty, "http://localhost:" + wireMockServer.port() + TRACING_URI))
                .applyTo(context);
        // TODO: set this property to a local zipkin/jaeger instance to see the spans
//        TestPropertyValues.of(Map.of(zipkinEndpointProperty, "https://eai-mservices-test-collector-zipkin.jaeger.corproot.net/api/v2/spans"))
//                .applyTo(context);
    }
}
